  ...
  return (
    <section className="relative min-h-[92vh] sm:min-h-screen flex flex-col justify-between items-center text-center px-4 sm:px-6 pt-16 sm:pt-24 pb-12 overflow-hidden">
      <motion.div
        ...
        className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-[#0d1422]/80 border border-[#d4af37]/30 backdrop-blur-md text-[11px] font-cinzel tracking-[0.25em] text-[#fae8c8]/80"
      >
      ...
      >
        <button
          ...
          className="group relative inline-flex items-center gap-2.5 px-6 sm:px-8 py-3 rounded-full bg-[#0a0f18]/90 border border-[#d4af37]/40 text-[#fae8c8] hover:border-[#d4af37] hover:bg-[#101722] transition-colors"
        >
